...
let ReadbookResult = require('./ReadbookResult.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class ReadbookActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new ReadbookResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ReadbookResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ReadbookActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = ReadbookResult.Resolve(msg.result)
    }
    else {
      resolved.result = new ReadbookResult()
    }
...
module.exports = ReadbookActionResult;
